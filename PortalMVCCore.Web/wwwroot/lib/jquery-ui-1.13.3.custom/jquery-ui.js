...
$.widget( "ui.dialog", {
	...
	_createTitlebar: function() {
		...
		this.uiDialogTitlebarClose = $("<button type='button' class='ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only ui-dialog-titlebar-close' role='button' aria-disabled='false' title='Fechar'><span class='ui-button-icon-primary ui-icon ui-icon-closethick'></span><span class='ui-button-text'>Fechar</span></button>")
			.button( {
