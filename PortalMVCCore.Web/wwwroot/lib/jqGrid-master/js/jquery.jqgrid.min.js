...
bindKeys:function(e){
	var d=$.extend({
		...
		return this.each(
			function(){
				var l=this,n=l.p,s=$(l);
				n.scrollrows=d.scrollingRows,s.on("keydown.jqGrid",
				function(t){var r=$(this).find("tr[tabindex=0]")[0],e=jgrid.detectRowEditing.call(l,$(t.target).closest("tr.jqgrow").attr("id")),i=function(e){do{if(null===(r=r[e]))return}while($(r).is(":hidden")||!$(r).hasClass("jqgrow"));base.setSelection.call(s,r.id,!0),t.preventDefault()},a=function(e,t){var r=d["on"+e+(t||"")];s.triggerHandler("jqGridKey"+e,[n.selrow]),$.isFunction(r)&&r.call(l,n.selrow)},o=function(e){if(n.treeGrid){var t=n.data[n._index[stripPref(n.idPrefix,r.id)]][n.treeReader.expanded_field];"Right"===e&&(t=!t),t&&$(r).find("div.treeclick").trigger("click")}a(e,"Key")};
				if(r&&null===e)
					switch(t.keyCode){
						case 38:i("previousSibling");break;
						case 40:i("nextSibling");break;
						case 37:o("Left");break;
						case 39:o("Right");break;
						case 13:a("Enter");break;
						case 32:a("Space");break;
						case 27:a("Esc");break;
						case 46:a("Delete");break;
					    case 65:a("A"); break;
					    case 67:a("C"); break;
					    case 69:a("E"); break;
						case 73:a("I");break;						
